...
import { publicReviews, createReview, myReviews, adminReviews, moderateReview } from "../controllers/review.controller.js";
...
router.patch("/admin/:id", protect, authorized("admin", "superAdmin"), moderateReview);
