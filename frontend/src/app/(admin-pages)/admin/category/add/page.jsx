    ...
    <div className="mx-auto max-w-3xl space-y-6 p-4 sm:p-6">
      ...
      >
        ...
        <div className="flex flex-col-reverse gap-3 border-t border-gray-100 bg-gray-50 px-4 py-4 sm:flex-row sm:justify-end sm:px-6">
          <Link
            href="/admin/category"
            className="min-h-11 rounded-xl border border-gray-200 bg-white px-6 py-2.5 text-center text-sm font-semibold text-gray-700 hover:bg-gray-50"
          >
            Cancel
          </Link>
          ...
          <button
            type="submit"
            className="inline-flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-xl bg-teal-600 px-6 py-2.5 text-sm font-semibold text-white hover:bg-teal-700"
          >
