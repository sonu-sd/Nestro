...
export default function Cart() {
  ...
  const cartReady =
    ...
    cart?.syncStatus !== "error";

  if (!cart?.hydrated)
    return (
      <main
        className="mx-auto min-h-screen max-w-7xl space-y-6 px-4 py-10 sm:px-6"
        aria-label="Loading cart"
      >
        <div className="h-10 w-56 animate-pulse rounded bg-[#E7D9C9]" />
        <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
          <div className="space-y-4">
            {[1, 2].map((item) => (
              <div
                key={item}
                className="h-44 animate-pulse rounded-2xl bg-[#E7D9C9]"
              />
            ))}
          </div>
          <div className="h-80 animate-pulse rounded-2xl bg-[#E7D9C9]" />
        </div>
      </main>
    );
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-[#888]">100% secure checkout</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-[#888]">Crafted for your home</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <section className="max-w-7xl mx-auto">
          <div className="min-h-[420px] bg-white border border-[#eadfd5] rounded-3xl flex flex-col items-center justify-center text-center px-6">
            ...
            <p className="mt-2 max-w-md text-sm leading-6 text-[#777]">
              ...
              collection and find something beautiful for your space.
            </p>
            <Link href="/store">
            ...
            <div className="rounded-2xl border border-[#eadfd5] bg-white p-4 shadow-[0_8px_30px_rgba(75,55,40,0.04)] sm:p-6">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-[#222]">₹{formatPrice(tax)}</span>
                </div>
              </div>
              ...
              {savings > 0 && (
                <div className="mt-5 rounded-xl bg-[#f1f8f2] px-4 py-3">
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-green-700">You save</span>
              ...
              <Link
                href={cartReady ? "/checkout" : "#"}
                aria-disabled={!cartReady}
              >
                <button
                  disabled={!cartReady}
                  className="group mt-6 w-full h-12 rounded-xl bg-[#8b5e3c] text-white text-xs font-semibold tracking-[1.5px] transition hover:bg-[#70482e] disabled:cursor-not-allowed disabled:opacity-60"
                >
              ...
              {cart?.syncStatus === "error" && (
                ...
                >
                  Your cart could not be saved. Check your connection before
                  checkout.
                </p>
              )}
