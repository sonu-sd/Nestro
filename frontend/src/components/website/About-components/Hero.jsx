    ...
    <div className="m-0 grid grid-cols-1 gap-8 bg-[#2c2016] p-6 sm:m-5 sm:rounded-2xl sm:p-10 lg:grid-cols-2 lg:p-13">
      <div className="items-center flex">
        <div className="col-span-1 ">
          <h2 className="text-3xl tracking-wide text-white sm:text-[36px] sm:tracking-wider">
          ...
          <p className="mt-3 text-[13px] leading-6 text-[#ffffff80]">
            ...
            honest in material, thoughtful in design, and built to outlast
            trends.
          </p>
        </div>
      </div>
      <div className="lg:col-span-1">
        <AppImage
          src="https://images.unsplash.com/photo-1593071045469-a45708d54b3d?auto=format&fit=crop&w=700&q=80"
          alt="Modern Nestro storage furniture"
