        ...
        <div className="mt-6 pb-4 border-b border-[#E7DDD1]">
            ...
            <div className="mt-3 pb-4 items-center gap-3">
                ...
                <div className='flex justify-between'>
                    <button onClick={Pricehandle} className='px-3 py-1 rounded-2xl mt-2 bg-amber-800'>
                        set price
                    </button>
                    <button onClick={Clerehandle} className='px-3 py-1 rounded-2xl mt-2 bg-amber-800'>
                        clere price
                    </button>
                </div>
                {
